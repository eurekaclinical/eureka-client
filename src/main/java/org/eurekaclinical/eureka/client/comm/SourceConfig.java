...
public class SourceConfig {
    ...
    public String toString() {
        return "SourceConfig{" + "id=" + id + ", displayName=" + displayName + ", ownerUsername=" + ownerUsername + ", dataSourceBackends=" + dataSourceBackends + ", knowledgeSourceBackends=" + knowledgeSourceBackends + ", algorithmSourceBackends=" + algorithmSourceBackends + ", termSourceBackends=" + termSourceBackends + ", read=" + read + ", write=" + write + ", execute=" + execute + '}';
    }
